# Intro to 3D with Qt Design Studio
...
- The 3D asset used in this project is sourced from [The Smithsonian Institution](https://www.si.edu/Termsofuse) and is in the public domain (CC0 1.0 Universal).
